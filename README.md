...
🔄 **Homomorphic Encryption (HE) - In Progress**: Complete HE VectorDB frontend integration and unit testing
🔄 **Video Encoding Optimization**: Update video encoding method for better performance
🔄 **Dead Time Bug Fix**: Address dead time between video chunks
🔄 **Retrieval Method Testing**: Set up and run tests for all four retrieval methods
🔄 **Design Pattern Documentation**: Complete design pattern documentation  
...
### Iteration 5
[Iteration 5 Demo Video](./iteration5_demo.mp4)

The demo video showcases the features added in Iteration 5:
1. Service onboarding tutorial for new users
2. Reset password functionality
3. VideoSet RAG with improved retrieval
4. Retrieved screen selection UI
5. Auto sign-in after signup

### Iteration 4
[Iteration 4 Demo Video](./iteration4_demo.mp4)

The demo video showcases the features added in Iteration 4:
1. Chat status indicator
2. LLM inference termination button
3. Delete chat sessions feature
4. Video search trigger icon
5. Mean pooling with hidden app screen
